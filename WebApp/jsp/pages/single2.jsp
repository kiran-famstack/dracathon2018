...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
    ...
    <!-- flexslider -->
	<link rel="stylesheet" href="${fn:escapeXml(css)}/flexslider.css" type="text/css" media="screen" />
    
	<!-- //navigation -->
	<!-- banner-2 -->
	<div class="page-head_agile_info_w3l hide">
	...
	<div class="banner-bootom-w3-agileits">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l hide">Single Page
			...
			<div class="col-md-5 single-right-left ">
				<div class="grid images_3_of_2">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="${fn:escapeXml(images)}/se1.jpg">
								<div class="thumb-image">
									<img src="${fn:escapeXml(images)}/se1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="${fn:escapeXml(images)}/se2.jpg">
								<div class="thumb-image">
									<img src="${fn:escapeXml(images)}/se2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="${fn:escapeXml(images)}/se3.jpg">
								<div class="thumb-image">
									<img src="${fn:escapeXml(images)}/se3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
						</ul>
	...
	<!-- imagezoom -->
	<script src="${fn:escapeXml(js)}/imagezoom.js"></script>
	<!-- //imagezoom -->

	<!-- FlexSlider -->
	<script src="${fn:escapeXml(js)}/jquery.flexslider.js"></script>
	<script>
